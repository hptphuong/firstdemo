(function() {
    ...
    var t = function(a) {
      ...
      , ia = function() {
        for (var a = Q.navigator.userAgent + (I.cookie ? I.cookie : "") + (I.referrer ? I.referrer : ""), b = a.length, c = Q.history.length; 0 < c; )
            a += c-- ^ b++;
        return [ae() ^ ic(a) & 2147483647, Math.round((new Date).getTime() / 1E3)].join(".")
    }
      , za = function(a) {
      ...
      , g = /^[\w\-:/.?=&%!]+$/
      , Ea = function(a, b, c, d) {
        a && (N("Loading script: %s", a),
        c ? (d = "",
        b && (g.test(b) ? d = ' id="' + b + '"' : J("Dropping invalid script ID: %s", b)),
        g.test(a) ? I.write("<script" + d + ' src="' + a + '">\x3c/script>') : J("URL uses invalid characters. Dropping request for: %s", a)) : (c = I.createElement("script"),
      ...
      , aa = function(a, b) {
        return (a = a.match("(?:&|#|\\?)" + P(b).replace(/([.*+?^=!:${}()|\[\]\/\\])/g, "\\$1") + "=([^&#]*)")) && 2 == a.length ? a[1] : ""
    }
      , Wb = function() {
    ...
    function L(a, b) {
        var c = Q.ga_debug;
        c && c.trace && (c = [].slice.call(arguments),
        c.unshift("log"),
        M.log.apply(M, c))
    }
    function dd(a, b) {
    ...
    function Xd(a) {
        for (var b = [], c = 0; c < a.length; c++)
            for (var d = 0; d < a[c].length - 1; d++)
                a[c][d] && (b[d] = b[d] || 0,
                b[d] = a[c][d].length > b[d] ? a[c][d].length : b[d]);
    ...
    function Ja(a) {
        ...
        for (var c = b.sort(), d = 0; d < c.length; d++)
            N("  " + c[d])
    }
    function Td(a) {
        for (var b in a)
            a.hasOwnProperty(b) && (Zb(ac, b) || (yc(b) ? J('This field cannot be set in a create method. Please use ga("set", %s, %s);', b, a[b]) : J("Create config had an unknown parameter: %s", b)),
            La(b, a[b]))
    }
    function Fa(a, b) {
        var c = b || 0;
    ...
    function Ha(a, b) {
        ...
        for (var c = a.split("%s"), d = 1; d < arguments.length; d++)
            c.splice(2 * d - 1, 0, Fa(arguments[d]));
        return c.join("")
    }
    function he(a) {
    ...
    var E = window
      ...
      , K = function(a) {
        ...
        if (b && b.ioo && b.ioo() || a && !0 === E["ga-disable-" + a])
            return !0;
        try {
            var c = E.external;
    ...
    var Md = function(a) {
      ...
      , pe = function(a, b, c, d, e, f) {
        K(e) ? ("function" == typeof N && N("Aborting cookie write: User has opted out of tracking."),
        e = !1) : Wd.test(I.location.hostname) || "/" == c && fe.test(d) ? ("function" == typeof N && N("Aborting cookie write: Prohibited domain."),
        e = !1) : e = !0;
        if (!e)
            return !1;
    ...
    var Da, Sb, cc, dc, ma = /^https?:\/\/[^/]*cdn\.ampproject\.org\//, sc = [], Uc = function() {
        jf.H([Aa])
    }, $c = function(a, b) {
        var c = Md("AMP_TOKEN");
        if (1 < c.length)
        ...
        if ("$OPT_OUT" == c || "$ERROR" == c || K(b))
            return F(62),
            !1;
        if (!ma.test(I.referrer) && "$NOT_FOUND" == c)
            return F(68),
            !1;
        if (void 0 !== dc)
            return F(56),
        ...
        if ("$RETRIEVING" == c)
            ...
            !0;
        Da = !0;
        c && "$" != c[0] || (ed("$RETRIEVING", 3E4),
        setTimeout(jd, 3E4),
        c = "");
        return ld(c) ? (sc.push(a),
        !0) : !1
    }, ld = function(a) {
        if (!window.JSON)
            return F(58),
        ...
        c.onload = function() {
            ...
            if (4 == c.readyState) {
                try {
                    200 != c.status && (J("Could not get client id from AMP."),
                    F(61),
                    yd("", "$ERROR", 3E4));
                    var a = JSON.parse(c.responseText);
                    a.optOut ? (J("Could not get client id from AMP. User has opeted out."),
                    F(63),
                    yd("", "$OPT_OUT", 31536E6)) : a.clientId ? (N("Got client id from AMP."),
                    yd(a.clientId, a.securityToken, 31536E6)) : (J("Could not get client id from AMP."),
                    F(64),
                    yd("", "$NOT_FOUND", 36E5))
                } catch (e) {
                    J("Could not get client id from AMP."),
                    F(65),
                    yd("", "$ERROR", 3E4)
                }
                c = null
    ...
    var hd = function() {
      ...
      , da = function(a, b, c) {
        ...
        if (2036 >= b.length)
            ...
            u(a, b, c) || te(a, b, c) || id(a, b, c),
            Ia(b);
        else
            throw O("Payload size is too large (%s).  Max allowed is %s.", b.length, 8192),
            fc("len", b.length),
            new bc(b.length);
    }
      , id = function(a, b, c) {
      ...
      , u = function(a, b, c) {
        return Q.navigator.sendBeacon ? Q.navigator.sendBeacon(a, b) ? (c(),
        !0) : !1 : !1
    }
      , fc = function(a, b, c) {
        O("Error: type=%s method=%s message=%s account=%s", arguments);
        if (!(1 <= 100 * Math.random() || K("?"))) {
            var d = ["t=error", "_e=" + a, "_v=j64d", "sr=1"];
            b && d.push("_f=" + b);
    ...
    ;
    function hc(a) {
        if (100 != a.get(Db) && ic(V(a, R)) % 1E4 >= 100 * jc(a, Db))
            throw N("User has been sampled out. Aborting hit."),
            "abort";
    }
    function kc(a) {
        if (K(V(a, U)))
    ...
    function lc() {
        ...
        if ("http:" != a && "https:" != a)
            throw N("Unallowed document protocol. Aborting hit."),
            "abort";
    }
    function mc(a) {
        try {
    ...
    function pc(a) {
        ...
        if (c) {
            ...
            "image" == c ? (id(b, d, e),
            Ia(d)) : "xhr" == c && te(b, d, e) ? Ia(d) : "beacon" == c && u(b, d, e) ? Ia(d) : (N("Transport Method, %s, is not supported, falling back to default method.", c),
            da(b, d, e))
        } else
            da(b, V(a, Na), a.get(Nb));
        b = a.get(U);
        b = h(b);
        c = b.hitcount;
        b.hitcount = c ? c + 1 : 1;
    ...
    function Ud() {
        if (Q.navigator && "preview" == Q.navigator.loadPurpose)
            throw N("Navigator in preview mode. Aborting hit."),
            "abort";
    }
    function ve(a) {
        var b = Q.gaDevIds;
    ...
    function ya(a) {
        if (!a.get(U))
            throw O("Tracking ID not set. Aborting hit."),
            "abort";
    }
    ;var ae = function() {
    ...
    function qc(a) {
        var b = jc(a, rc);
        500 <= b && (F(15),
        N("Exceeded maximum number of hits for this page. Try reducing the number of hits being sent."));
        var c = V(a, Ma);
        if ("transaction" != c && "item" != c) {
            ...
            a.set(vc, d));
            if (0 >= c)
                throw N("Exceeded rate limit for sending hits. Aborting hit."),
                "abort";
            a.set(uc, --c)
        }
        a.set(rc, ++b)
    ...
    wc.prototype.set = function(a, b, c) {
        if (a)
            if ("object" == typeof a)
                for (var d in a)
                    a.hasOwnProperty(d) && zc(this, d, a[d], c);
            else
                zc(this, a, b, c)
    }
    ;
    ...
    var Ob = X("_oot")
      ...
      , ac = [T, U, R, n, xe, ub, S, vb, Cb, Yd, wb, Id, Kb, Lb, Db, Eb, Mb, xb, ce, We]
      , ob = W("transportUrl")
      , De = W("_r", "_r");
    function Y(a, b, c, d) {
        b[a] = function() {
    ...
    ;var ba = function(a) {
        ...
        return ic(V(a, R)) % 100 >= b ? (L("Site speed data not sent - visitor sampled out"),
        !1) : !0
    }
      , Sc = function(a) {
        var b = {};
        if (qd(b) || rd(b)) {
            var c = b[Ic];
            void 0 == c || Infinity == c || isNaN(c) ? L("Site speed data not sent - unsupported browser") : 0 < c ? (Rc(b, Kc),
            Rc(b, Nc),
            Rc(b, Mc),
            Rc(b, Jc),
            Rc(b, Lc),
            ...
            ta(function() {
                a(b)
            }, 10)) : (L("Site speed data not available - waiting for onload"),
            Ca(Q, "load", function() {
                Sc(a)
            }, !1))
        } else
    ...
    var Tc = !1
        ...
        if ("cookie" == V(a, xb)) {
            ...
            if (a.get(We)) {
                ...
                if (c) {
                    ...
                    var ea = Xc(V(a, S));
                    a = V(a, U);
                    f && "aw.ds" != f || (c = ["1", e, Ae(c)].join("."),
                    0 < d && pe("_gac_" + Ae(a), c, b, ea, a, d));
                    Ye({})
                }
            } else
                F(75)
      ...
      , Zc = function(a) {
        if ("cookie" == V(a, xb) && !Tc && (Yc(a),
        !Tc))
            throw N("Storage not available. Aborting hit."),
            "abort";
    }
      , Kd = function(a) {
        if (a.get(Id)) {
      ...
      , sd = function(a, b, c) {
        for (var d = [], e = [], f, ea = 0; ea < a.length; ea++) {
            var l = a[ea];
            l.K[c] == b ? d.push(l) : void 0 == f || l.K[c] < f ? (e = [l],
            f = l.K[c]) : l.K[c] == f && e.push(l)
        }
    ...
    function Jd(a, b, c) {
        ...
        if (0 != d.length)
            return 1 == d.length ? d[0] : Ld(b, d) || Ld(c, d) || Ld(null, d) || d[0]
    }
    function Ld(a, b) {
        if (null == a)
            var c = a = 1;
    ...
    function nd(a) {
        ...
        if ((c = a.get(ue)) && a.get(We)) {
            var d = jc(a, Ge);
            1E3 * d + jc(a, Qe) <= (new Date).getTime() ? (F(76),
            a = "") : (F(44),
            a = "&_gac=1." + P([ra(c, 0), d, c].join(".")))
        } else
            a = "";
        return b + a
    }
    ...
    var le = function(a, b, c) {
      ...
      , me = function(a, b) {
        if (b)
            if (b.action)
                if (N("Linker decorating form: %s", b),
                "get" == b.method.toLowerCase()) {
                    ...
                    "post" == b.method.toLowerCase() ? b.action = le(a, b.action) : O("Unknown form method %s on %s", b.method, b);
            else
                O("An action is required for the linker to work.")
    };
    pd.prototype.U = function(a, b, c) {
        function d(c) {
            try {
                ...
                "http:" != f.protocol && "https:" != f.protocol || !ne(a, f.hostname || "") || (f.href && (f.href = le(e, f.href, b)),
                N("Link decorated: " + f.href))
            } catch (k) {
                F(26)
            }
        }
    ...
    var Fe = function(a, b, c) {
      ...
      , Ke = function(a, b) {
        ...
        pe(a.aa, "1", b.get(vb), b.get(S), b.get(U), 6E4))
    }
      , Ee = function(a, b) {
        if (b.get(a.Y)) {
            var c = new ef
    ...
    var Nd, Od = function(a, b, c) {
        if (!Nd) {
            ...
            var e = Q.name
              , f = /^#?gaso=([^&]*)/;
            if (e = (d = (d = d && d.match(f) || e && e.match(f)) ? d[1] : Md("GASO")[0] || "") && d.match(/^(?:!([-0-9a-z.]{1,40})!)?([-.\w]{10,1200})$/i))
                pe("GASO", "" + d, c, b, a, 0),
            ...
            Ea(c, void 0, void 0, function() {
                try {
                    ...
                    if (e && 1 == e.length && f && 1 == f.length) {
                        ...
                        d.push("id=10");
                        for (var v in k)
                            k.hasOwnProperty(v) && d.push(v + "=" + P(k[v]));
                        d.push("z=" + ae());
    ...
    var va = /^(UA|YT|MO|GP)-(\d+)-(\d+)$/
      ...
      , vd = function(a, b) {
        ...
        if ("cookie" == V(a, xb)) {
            ...
            if (d = c && !a.get(Yd))
                ...
                2 != d.length)
                    ...
                    d = !1;
            d && (c = void 0,
            J("Client id is ignored because cookie update is disabled"));
            c && (a.data.set(Qd, c),
            a.data.set(R, c),
            c = Md(V(a, na)),
            (c = de(a, c)) && a.data.set(la, c));
            if (a.get(We) && (c = a.get(ue),
            d = a.get(Ve),
            !c || d && "aw.ds" != d)) {
                c = {};
                d = [];
                ...
                if (d && 0 != d.length) {
                    for (f = 0; f < d.length; f++)
                        (ea = d[f].value.split("."),
                        "1" != ea[0] || 3 != ea.length) ? c && (c.qa = !0) : ea[1] && (e[d[f].ma] ? c && (c.sa = !0) : e[d[f].ma] = [],
                        e[d[f].ma].push({
                            timestamp: ea[1],
                            ta: ea[2]
                        }));
                    Object.keys && 1 < Object.keys(e).length && c && (c.va = !0)
                }
                d = e[V(a, U)];
                Ye(c);
                d && 0 != d.length && (c = d[0],
                a.data.set(Ge, c.timestamp),
                a.data.set(ue, c.ta))
            }
        }
        if (a.get(Yd))
            a: if (c = ee("_ga", a.get(Lb)))
                if (a.get(Kb))
                    if (e = c.indexOf("."),
                    -1 == e)
                        J("Invalid linker parameter format: " + c),
                        F(22);
                    else {
                        ea = c.substring(0, e);
                        f = c.substring(e + 1);
                        ...
                        if ("1" == ea) {
                            ...
                            e = f.indexOf("-");
                            ea = "";
                            0 < e ? (ea = f.substring(0, e),
                            e = f.substring(e + 1)) : e = f.substring(1);
                            if (Xe(ea + e, d)) {
                                J("Bad or expired linker parameter hash: " + c);
                                F(53);
                                break a
                        ...
                        F(11);
                        a.data.set(R, e);
                        if (c = ee("_gac", a.get(Lb)))
                            c = c.split("."),
                            "1" != c[0] || 4 != c.length ? F(72) : Xe(c[3], c[1]) ? F(71) : (a.data.set(ue, c[3]),
                            a.data.set(Ge, c[2]),
                            F(70))
                    }
                else
                    J("Linker disabled. Ignoring linker parameter: " + c),
                    F(21);
        ...
        F(17),
        a.data.set(R, b)) : (Ga("New visitor. Generating new clientId"),
        F(8),
        a.data.set(R, ia())));
        a.get(la) || (Ga("Generating new gid"),
        F(3),
        a.data.set(la, ia()));
        Yc(a)
    }
      , wd = function(a) {
        ...
        if (d && a.get(Lb) && (b = I.location.hash)) {
            ...
            d = [];
            for (c = 0; c < b.length; ++c)
                (H(b[c], "utm_id") || H(b[c], "utm_campaign") || H(b[c], "utm_source") || H(b[c], "utm_medium") || H(b[c], "utm_term") || H(b[c], "utm_content") || H(b[c], "gclid") || H(b[c], "dclid") || H(b[c], "gclsrc")) && d.push(b[c]);
            0 < d.length && (b = "#" + d.join("&"),
            a.set(Pa, a.get(Pa) + b))
        }
    };
    ...
    ad.prototype.send = function(a) {
        ...
        if (1 > arguments.length)
            O("No hit type specified. Aborting hit.");
        else {
            if ("string" === typeof arguments[0]) {
                var b = arguments[0];
                var c = [].slice.call(arguments, 1)
            } else
                b = arguments[0] && arguments[0][Ma],
                c = arguments;
            b ? (c = Yb(bd[b] || [], c),
            c[Ma] = b,
            ...
            this.a.data.u = {},
            ye(this.ua, this.a) && fa(this.a.get(U))) : O("No hit type specified. Aborting hit.")
        }
    }
    ;
    ...
    var qe = /^(?:(\w+)\.)?(?:(\w+):)?(\w+)$/
      , se = function(a) {
        ...
        if (t(a[0]))
            ...
            this.I || (this.D = "create" == this.A,
            this.g = "require" == this.A,
            this.f = "provide" == this.A,
            this.$ = "remove" == this.A),
            this.g && (3 <= this.b.length ? (this.da = this.b[1],
            this.ba = this.b[2]) : this.b[1] && (G(this.b[1]) ? this.da = this.b[1] : this.ba = this.b[1])));
            b = a[1];
            var c = a[2];
            if (!this.A)
                throw O("Invalid command: " + a),
                "abort";
            if (this.g && (!G(b) || "" == b))
                throw O("Invalid require command.", a),
                "abort";
            if (this.f && (!G(b) || "" == b || !t(c)))
                throw O("Invalid provide command.", a),
                "abort";
            if (re(this.c) || re(this.I))
                throw O('Target name and plugin names should not contain "." or ":"'),
                "abort";
            if (this.f && "t0" != this.c)
                throw O("Provide command should not be preceeded by a tracker name."),
                "abort";
        }
    };
    function re(a) {
      ...
      , z = function(a, b, c, d, e) {
        if (!t(Re.get(b)) && !Te.get(b)) {
            ...
            if (p.test(b)) {
                ...
                "t0" != f && (d.target = f);
                K(String(a.get("trackingId"))) || (d.clientId = String(a.get(R)),
                d.na = Number(a.get(n)),
                c = c.palindrome ? r : q,
                c = (c = I.cookie.replace(/^|(; +)/g, ";").match(c)) ? c.sort().join("").substring(1) : void 0,
                d.oa = c,
                d.ta = aa(a.a.get(Pa) || "", "gclid"));
                a = d.F;
                c = (new Date).getTime();
                Q[a] = Q[a] || [];
                c = {
            ...
            !c && Se.hasOwnProperty(b) ? (F(39),
            c = b + ".js") : F(43);
            c ? (c && 0 <= c.indexOf("/") || (c = ($b || df() ? "https:" : "http:") + "//www.google-analytics.com/plugins/ua/" + c),
            d = Ue(c),
            a = d.protocol,
            c = I.location.protocol,
    ...
    jf.H = function(a) {
        ...
        for (jf.j = []; 0 < b.length; ) {
            ...
            if (c.s)
                ...
                for (var d = [], e = 0; c.G && e < c.G.length; e++)
                    d.push(Fa(c.G[e]));
                c = "ga(" + d.join(", ") + ")"
            }
    ...
    jf.N = function(a) {
        for (var b = [], c = 0; c < arguments.length; c++)
            try {
                ...
                d.f ? (D(d.b[0], d.b[1]),
                N("Registered new plugin: ga(provide, %s, Function)", d.b[0])) : (d.g && (d.ha = z(d.c, d.b[0], d.da, d.ba)),
                b.push(d))
            } catch (l) {
                var e = arguments[c]
                  , f = d
    ...
    jf.R = function(a) {
        try {
            if (a.s)
                ...
                if (a.D)
                    if ("t0" != a.c)
                        J('Command ignored. Use "create" instead of "%s.create"', a.c);
                    else {
                        if (b = Z.create.apply(Z, a.b),
                        null === b)
                            return !0
                    }
                else if (a.$)
                    ...
                    N("Command ignored. Unknown target: " + b)
            }
        } catch (ea) {
            c = ea,
            a.s ? O("Exception thrown from pushed function: %s", c) : a.g ? O("Error creating a plugin instance: %s", a.G) : a.f ? O("Error registering a plugin: %s", a.G) : a.$ ? O("Error removing tracker: %s", a.G) : a.I ? O("Error calling a plugin method: %s", a.G) : O('Called method "%s" threw exception: %s', a.A, c)
        }
    }
    ;
    var Z = function(a) {
    ...
    Z.create = function(a) {
        ...
        var c = "" + b[T];
        if (Z.o[c])
            return J("Ignoring create request for duplicate tracking name."),
            Z.o[c];
        a: {
            if (b[ce]) {
                F(67);
                ...
                if (void 0 !== dc)
                    b[R] ? J("Using client id from config instead of AMP.") : b[R] = dc;
                else {
                    b: {
                        d = String(b[S] || Wb());
                        var e = String(b[vb] || "/")
                          , f = Md(String(b[ub] || "_ga"));
                        d = pa(f, d, e);
                        if (!d || Bd.test(d))
                            d = !0;
                    ...
                    if (d)
                        if ($c(Uc, String(b[U]))) {
                            ...
                            J("Could not request client id from AMP.")
                }
            }
            d = !1
        }
    ...
    Z.P = function() {
        ...
        var a = Q[Fc];
        if (a && 42 == a.answer)
            J("Tracking script already loaded. Abandoning initialization.");
        else {
            ...
            df() || $b || !ye(new Ie) || (L("Sending all Hits by SSL"),
            F(36),
            $b = !0);
    ...
    ;
    Z.ga = function() {
        for (var a = Z.getAll(), b = 0; b < a.length; b++)
            dd("Tracker: " + a[b].get(T)),
            Ja(a[b].a),
            ge();
        a = I.cookie;
        dd("Cookie Information");
        a = a.split("; ");
        b = [["Name", "Domain", "Path", "Value"]];
        for (var c = 0; c < a.length; c++) {
            var d = a[c].split("=")
              , e = d[0];
            d = d[1] || "";
            if (Zb(tc, e))
                ...
                var f = ""
                  ...
                  , l = d.split(".")[1];
                l && (l = l.split("-"),
                f = I.location.hostname.split("."),
                f = f.slice(f.length - l[0]).join("."),
                ea += I.location.pathname.split("/").slice(1, l[1] || 1).join("/"));
                b.push([e, f, ea, d])
            } else
                /^((__utmt)|(_gat))/.test(e) && b.push([e, "", "", d])
        }
        Xd(b);
        ge()
    }
