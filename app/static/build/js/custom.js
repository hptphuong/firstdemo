...
function generate_html_linechart_tooltip(d, m_back) {
    ...
    if (d[1].value != 0) {
        ...
        tooltip_content += Math.round(Math.abs(d[0].value - d[1].value) / d[1].value * 100) + `%`;
    }
...
function plot_fsa_new_user_chart(array_range_date) {
    // This function will be plot new_user_chart in index.html
    // $('div#new_users.tab-pane.fade.tab-size').html('<div id="new_user_chart" ></div>');
    // var x_val = ['x'],
    //     x_val2 = ['x2'],
    //     data1 = ['data1'],
...
function init_audiance_timerange_right() {
    ...
    console.log('init_audiance_timerange_right');
    ...
    $('#audiance_timerange_right').on('hide.daterangepicker', function() {
        console.log("hide event fired");
    });
    $('#audiance_timerange_right').on('apply.daterangepicker', function(ev, picker) {
